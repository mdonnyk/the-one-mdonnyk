...
public class EpidemicActiveWTombstoneRouter implements RoutingDecisionEngine {
    ...
    public EpidemicActiveWTombstoneRouter(Settings s) {

    }

    protected EpidemicActiveWTombstoneRouter(EpidemicActiveWTombstoneRouter proto) {
    ...
    public void connectionUp(DTNHost thisHost, DTNHost peer) {
        EpidemicActiveWTombstoneRouter peerRouter = this.getAnotherRouter(peer);
        ...
        Set<String> peerTombstone = peerRouter.getTombstone();
    ...
    public RoutingDecisionEngine replicate() {
        return new EpidemicActiveWTombstoneRouter(this);
    }

    private EpidemicActiveWTombstoneRouter getAnotherRouter(DTNHost peer) {

...
public class BufferOccupancyPerDayReport extends Report implements UpdateListener {
	...
	public static final int DEFAULT_BUFFER_REPORT_INTERVAL = 86400;
	...
	public BufferOccupancyPerDayReport() {
		super();
	...
	public void updated(List<DTNHost> hosts) {
		...
		if (simTime - lastRecord >= interval) {
			...
			printLine(hosts);
			System.out.println("Simulation time :"+updateCounter+" days");
